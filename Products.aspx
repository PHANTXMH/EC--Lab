...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <asp:Button ID="Button1" runat="server" Text="Add to Cart" class="btn"/>
    <br />
    <br />
    ...
    <asp:Button ID="Button4" runat="server" Text="Add to Cart" class="btn"/>
    <br />
    <br />
    ...
    <asp:Button ID="Button5" runat="server" Text="Add to Cart" class="btn"/>
    <br />
    <br />
    ...
    <asp:Button ID="Button6" runat="server" Text="Add to Cart" class="btn"/>
    <br />
    <br />
    ...
    <asp:Button ID="Button7" runat="server" Text="Add to Cart" class="btn"/>
    <br />
    <br />
    ...
    <asp:Button ID="Button8" runat="server" Text="Add to Cart" class="btn"/>
    <br />
    <br />
    ...
    <asp:Button ID="Button9" runat="server" Text="Add to Cart" class="btn"/>
    <br />
    <br />
</asp:Content>
